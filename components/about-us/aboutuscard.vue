  ...
  <section class="w-9/10 mx-auto my-0px">
    ...
    >
      <div class="text <lg:(w-3/4 mt-5 h-1/3 text-center) w-1/2">
        ...
        <p class="text-gray-300">
          One of the prominent pillars of COPS, IITBHU is SDG. With the
    ...
    >
      ...
      <div class="text <lg:(w-3/4 mt-5 h-1/3 text-center) w-1/2">
        ...
        <p class="text-gray-300">
          Whether Mobile Development, Desktop Development, Web Development, Game
    ...
    >
      <div class="text <lg:(w-3/4 mt-5 h-1/3 text-center) w-1/2">
        ...
        <p class="text-gray-300">
          Our motto is constantly learning and revamping. Hackalog, our very own
